...
class TestLedgerPresenter(unittest.TestCase):
    ...
    def testRunQueryWithAsnsNoLedgerRex(self):
        ...
        self.assertEqual(gbl.dataset.get_unsent_invoices(), test_data.invoice_items_qtr_2)

        # verify display updated
        self.assertEqual(self.view.work_list_ctrl.GetObjects(), test_data.invoice_items_qtr_2)
    ...
    def testRunQueryWithAsnsAndLedgerRex(self):
        ...
        # verify global ledger data all built from billable assignments
        self.assertEqual(gbl.dataset.get_unsent_invoices(), test_data.invoice_items_qtr_1)

        # verify display updated
        self.assertEqual(self.view.work_list_ctrl.GetObjects(), test_data.invoice_items_qtr_1)
    ...
    def testLoadDetails_No_Salary(self):
        ...
        with patch('lib.ui_lib.show_error') as mock_popup:
            ...
            click_list_ctrl(self.view.work_list_ctrl, 2)
        ...
        self.assertEqual(self.view.prj_lbl.GetLabelText(), 'Prj 299')
        self.assertEqual(self.view.asn_lbl.GetLabelText(),
                         'MANTLE,MICKEY: 10% effort, from 10/19 thru 11/19 (61 days)')
    ...
    def testLoadDetailsWithSalaryNoUserInput(self):
        ...
        with patch('lib.ui_lib.show_error') as mock_popup:
            mock_popup.return_value = None
            click_list_ctrl(self.view.work_list_ctrl, 1)
    ...
    def testLoadDetailsWithSalaryAndUserInput(self):
        ...
        self.assertEqual(self.view.prj_lbl.GetLabelText(), 'Prj 297')
        self.assertEqual(self.view.asn_lbl.GetLabelText(),
                         'BANKS,ERNEST: 45% effort, from 10/19 thru 12/19 (92 days)')
        self.assertEqual(self.view.cost_lbl.GetLabelText(),
                         'Salary: $44,444, Fringe: 4.4%, Total/Day: $177.86')
        self.assertEqual(self.view.amount_ctrl.GetValue(), '7,363.45')
    ...
    def testAddEntryWithAmountChange(self):
        ...
        vals = ['20201', 'CARDIOLOGY', '1', '1', 'K0H0002',
                ...
                '0', '1000.0', '123456', 'MARX,HARPO', 'harpo@umich.edu'
        ]
    ...
    def testUpdateEntryWithAmountChange(self):
        ...
        sql = ("UPDATE ledger "
               ...
               "WHERE id=?;")
        vals = [
            'CARDIOLOGY', '1', '1', 'K0H0002',
            '1000.0', '1000.0','123456',
            'MARX,HARPO', 'harpo@umich.edu', '0', 2]
        self.assertEqual(args[0], sql)
        self.assertEqual(args[1], vals)
